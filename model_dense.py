...
from keras.layers import Input, Dense, Conv2D, BatchNormalization, Activation, Concatenate
from keras.layers import AveragePooling2D, GlobalAveragePooling2D, Reshape, Dropout
